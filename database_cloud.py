"""database_cloud.py — Supabase client and all database operations."""
...
# ── Usage logs ────────────────────────────────────────────────────────────────
async def log_token_usage(user_id: str, session_id: str, agent: str,
                          provider: str, model_id: str, tokens: int):
    db = get_client()
